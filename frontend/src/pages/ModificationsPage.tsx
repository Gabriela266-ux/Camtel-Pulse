    ...
    <div className="min-h-screen:bg-slate-50 p-6">
      <div className="mx-auto max-w-7xl">
        <button
          ...
          className="mb-5 inline-flex items-center gap-2 text-sm font-bold text-slate-600 hover:text-sky-700"
        >
        ...
        <section className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
          <div className="flex flex-wrap items-start justify-between gap-4">
            <div>
              ...
              <h1 className="mt-1 text-2xl font-black text-slate-900">Détails des modifications</h1>
              <p className="mt-2 text-sm text-slate-500">Consultez les ajouts DSM/POS, saisies, corrections et affectations.</p>
            </div>
          ...
          <div className="mt-6 flex flex-wrap gap-3 border-t border-slate-100 pt-4">
            <label className="inline-flex items-center gap-2 text-xs font-bold text-slate-600">
              ...
              <select
                ...
                className="rounded-lg border border-slate-200 bg-slate-50 px-3 py-2 text-xs font-medium text-slate-700 outline-none focus:ring-2 focus:ring-sky-200"
              >
              ...
              <thead>
                <tr className="bg-slate-50">
                  {['Date', 'Auteur', 'Action', 'Partenaire', 'Entité', 'Détails', 'Statut'].map((column) => (
                    <th
                      key={column}
                      className="whitespace-nowrap border-b border-slate-200 px-4 py-3 text-left text-[11px] font-black uppercase tracking-wide text-slate-400"
                    >
                      {column}
                    </th>
                  ))}
